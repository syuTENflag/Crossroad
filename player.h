...
// キャラクター
#define GAME_CHARA_OJO		0
#define GAME_CHARA_ASN	    1
#define GAME_CHARA_REIMU	2
...
private:
	...
	static int model_handle_ojo;		// お嬢様のハンドル
	static int model_handle_asn;		// アスナのハンドル
	static int model_handle_reimu;	// 霊夢のハンドル
